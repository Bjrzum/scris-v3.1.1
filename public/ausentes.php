...
<body>
    ...
    <header class="header">
        ...
        <nav class="nav">
            ...
            <a href="ausentes.php" class="link__nav link__nav--active">Ausentes</a>
    ...
    <section class="section">
        <div class="flex">
            ...
            while ($fila = $resultado->fetch()) {
                ...
                $sql2 = "SELECT * FROM tabla WHERE fecha = '$fecha_hoy' AND nombre = '$nombre'";
