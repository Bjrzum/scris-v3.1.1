...
<body>
    ...
    <header class="header">
        ...
        <nav class="nav">
            ...
            <a href="salidas.php" class="link__nav link__nav--active">Salidas</a>
    ...
    <section class="section">
        <div class="flex">
            ...
            while ($fila = $resultado->fetch()) {
                ...
                $sql2 = "SELECT * FROM tabla WHERE fecha = '$fecha_hoy' AND nombre = '$nombre' AND (status = '1' OR status = '3')";
